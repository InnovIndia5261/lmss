    ...
    <div>
      ...
      <div className="px-4 mt-8">
        <Card customClass="bg-white shadow">
          <h6 className="text-lg font-semibold border-b pb-2 mb-4">My Borrowed Books</h6>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {/* Mock Borrowed Books */}
            <div className="border rounded-lg p-4 bg-gray-50">
              <h5 className="font-bold">1984</h5>
              <p className="text-sm text-gray-600">George Orwell</p>
              <p className="text-xs text-red-500 mt-2">Due Date: 2026-03-01</p>
            </div>
            <div className="border rounded-lg p-4 bg-gray-50">
              <h5 className="font-bold">The Great Gatsby</h5>
              <p className="text-sm text-gray-600">F. Scott Fitzgerald</p>
              <p className="text-xs text-red-500 mt-2">Due Date: 2026-02-28</p>
            </div>
          </div>
        </Card>
      </div>
